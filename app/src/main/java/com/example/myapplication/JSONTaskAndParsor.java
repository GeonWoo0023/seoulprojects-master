...
public class JSONTaskAndParsor extends AsyncTask<String, String, String> {
    ...
    public JSONTaskAndParsor(ArrayList<SponsorBoardBin> slist, ArrayList<InfoBoardBin> list ) {
        this.list = list;
        this.slist = slist;
