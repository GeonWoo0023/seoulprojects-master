    ...
    private void selectFragment(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.menu_home:
                ...
                //Toast.makeText(getContext(),"홈",Toast.LENGTH_SHORT).show();
                break;
            case R.id.menu_News:
                frag = Container_NewsFragment.newInstance();
                //Toast.makeText(getContext(),"정보알림",Toast.LENGTH_SHORT).show();
                break;
            case R.id.menu_mylocation:
                frag = Container_MyLocationFragment.newInstance();
                //Toast.makeText(getContext(),"내주변",Toast.LENGTH_SHORT).show();
                break;
            case R.id.menu_sponsor:
                frag= Container_SponsorFragment.newInstance();
                //Toast.makeText(getContext(),"후원",Toast.LENGTH_SHORT).show();
                break;
            case R.id.menu_info:
